...
int16_t ECOCALLMETHOD CEcoCalculatorEFactory_Alloc(/* in */ struct IEcoComponentFactory* me, /* in */ struct IEcoUnknown *pISystem, /* in */ struct IEcoUnknown *pIUnknownOuter, /* in */ const UGUID* riid, /* out */ void** ppv) {
    ...
    /* Создание компонента */
    result = pCMe->m_pInstance(pISystem, pIUnknownOuter, (void**)&pIUnk);  // CalculatorE supports aggregation
    if ( result != 0 || pIUnk == 0) {
        return -1;
    }
...
IEcoComponentFactoryVTbl g_x4828F6552E4540E78121EBD220DC360FFactoryVTbl = {
 ...
 *
 */
CEcoCalculatorEFactory g_x4828F6552E4540E78121EBD220DC360FFactory = {
    &g_x4828F6552E4540E78121EBD220DC360FFactoryVTbl,
    0,
...
//     return (IEcoComponentFactory*)&g_x4828F6552E4540E78121EBD220DC360FFactory;
// };
#endif

#if defined(ECO_LIB) || defined(ECO_DLL)
IEcoComponentFactory* GetIEcoComponentFactoryPtr_4828F6552E4540E78121EBD220DC360F = (IEcoComponentFactory*)&g_x4828F6552E4540E78121EBD220DC360FFactory;
#endif