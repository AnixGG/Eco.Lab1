 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoCalculatorC_QueryInterface(/* in */ IEcoCalculatorX* me, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)me - offsetof(CEcoCalculatorC, m_pVTblIX));
 ...
 *
 */
static uint32_t ECOCALLMETHOD CEcoCalculatorC_AddRef(/* in */ IEcoCalculatorX* me) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)me - offsetof(CEcoCalculatorC, m_pVTblIX));
 ...
 *
 */
static uint32_t ECOCALLMETHOD CEcoCalculatorC_Release(/* in */ IEcoCalculatorX* me) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)me - offsetof(CEcoCalculatorC, m_pVTblIX));
 ...
 *
 */
static int32_t ECOCALLMETHOD CEcoCalculatorC_Addition(/* in */ IEcoCalculatorX* me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)me - offsetof(CEcoCalculatorC, m_pVTblIX));
    ...
    printf("EcoCalculatorC: Addition called with %d + %d\n", a, b);
    return (int32_t)a + b;
}
 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoCalculatorC_Subtraction(/* in */ IEcoCalculatorX* me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)me - offsetof(CEcoCalculatorC, m_pVTblIX));
    ...
    printf("EcoCalculatorC: Subtraction called with %d - %d\n", a, b);
    return (int16_t)(a - b);
}
 ...
 *
 */
int16_t ECOCALLMETHOD initCEcoCalculatorC(/*in*/ IEcoCalculatorX* me, /* in */ IEcoUnknown *pIUnkSystem) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)me - offsetof(CEcoCalculatorC, m_pVTblIX));
...
int16_t ECOCALLMETHOD createCEcoCalculatorC(/* in */ IEcoUnknown* pIUnkSystem, /* out */ IEcoCalculatorX** ppIEcoCalculatorX) {
    ...
    result = initCEcoCalculatorC((IEcoCalculatorX*)pCMe, pIUnkSystem);
    if (result != 0) {
...
void ECOCALLMETHOD deleteCEcoCalculatorC(/* in */ IEcoCalculatorX* pIEcoCalculatorX) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint8_t*)pIEcoCalculatorX - offsetof(CEcoCalculatorC, m_pVTblIX));
    IEcoMemoryAllocator1* pIMem = 0;
